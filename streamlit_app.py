...
# sigue con los formularios, contadores y ventas si necesitas que los vuelva a pegar
    ...
    if enviar:
        if not fotos:
            ...
            try:
                ...
                anterior = int(user.get(col_destino, 0)) if str(user.get(col_destino, 0)).isdigit() else 0
