...
from drive_upload import conectar_drive, subir_archivo_a_carpeta as subir_archivo_a_drive
import time
import uuid
import re
import tempfile
    ...
    if correo_usuario == ADMIN_EMAIL:
        ...
        with st.expander("SUBIR NUEVAS PROMOCIONES", expanded=False):  # Eliminado el emoji
            ...
            with st.container():
                ...
                imagenes = st.file_uploader("Sube los tickets o imágenes de comprobante", type=["jpg", "png", "jpeg"]) accept_multiple_files=True, 
